...
export default function Produto(props){
    ...
    function adicionarProdutoCarrinho(produto){
        props.setCarrinhoItens([...props.carrinhoItens, produto]);
    }

    function removerProdutoCarrinho(produto){
        props.setCarrinhoItens(props.carrinhoItens.filter((produtoi => produtoi.id !== produto.id)))
    }
            ...
            <div style={{
                ...
                <div id='botao-comprar'>
                    <button 
                        ...
                        type='button'
                        onClick={()=>{
                            adicionarProdutoCarrinho(props.produto)}
                        }
                        >
                            Comprar
                    </button>
            ...
            <div style={{
                ...
                <div id='botao-acoes'>
                    <button 
                        ...
                        type='button'
                        onClick={()=>{
                            removerProdutoCarrinho(props.produto)}
                        }
                        >
                            Remover
                    </button>
